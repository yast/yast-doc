...
<!-- ==================================================================== -->
<xsl:param name="toc.pointer.image">images/blank.gif</xsl:param>
...
<!-- ==================================================================== -->
<xsl:param name="toc.blank.image">images/blank.gif</xsl:param>
...
<xsl:param name="table.spacer.image" select="'images/spacer.gif'"/>
